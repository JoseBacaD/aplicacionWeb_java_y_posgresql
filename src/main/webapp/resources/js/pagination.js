$.fn.pageMe = function(opts){
    ...
    $("#total_reg").html(numItems+" Registro(s) en total");

    pager.data("curr",0);

    if (settings.showPrevNext){
        $('<li><a href="#" class="prev_link" title="'+settings.prevText+'"><i class="fas fa-chevron-left"></i></a></li>').appendTo(pager);
    }
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="next_link"  title="'+settings.nextText+'"><i class="fas fa-chevron-right"></i></a></li>').appendTo(pager);
    }
